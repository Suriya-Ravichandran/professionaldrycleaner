<div class="page-section">
    ...
    <div class="text-center wow fadeInUp">
        <div class="subhead"><h4>Contact Us</h4></div>
        <!-- <h2 class="title-section">Discover Our Dry Cleaning Services!</h2> -->
      ...
      <div class="row text-center align-items-center">
        <div class="col-lg-4 py-3">
          ...
          <p class="mb-0 text-secondary">No. 1 & 2, Clemens Rd, Near Super Saravana Stores, Purasaiwakkam, Chennai - 600007</p>
        </div>
        <div class="col-lg-4 py-3">
          ...
          <p class="mb-0"><a href="tel:9500993047" class="text-secondary">+91 9500993047</a></p>
        </div>  
        <div class="col-lg-4 py-3">
    ...
    <div class="container-fluid mt-4">
      <div class="row">
        ...
        <div class="col-lg-6 px-0">
          ...
          <div class="maps-container" id="locate-us">
            <div id="google-maps">
